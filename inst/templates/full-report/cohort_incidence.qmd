...
cat(paste0("\n\n### Incidence rates for ", cohortDefinitions$friendlyName[cohortDefinitions$cohortDefinitionId == headings$outcomeId[ind]]), " during ", headings$tar[ind] ," washout ", headings$cleanWindow[ind] ,"\n\n")
      ...
      boxTitle <- paste0("Click to open the incidence proportion/rate table for all available targets")
