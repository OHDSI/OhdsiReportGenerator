...
cohortDefinitions <- 
  merge(
    ...
    by.x = 'subsetParent', 
    by.y = 'cohortId', 
    all.x = T # TODO - change this if we want to ignore all other cohorts? 
  )
...
cohortDefinitions <- merge(cohortDefinitions, subsetDefFriendly, by = 'subsetDefinitionId', all.x = T)
