...
includeScc <- 'scc' %in% prefixes & params$includeScc
...
```{r}
#| label: self_controlled_cohort
#| echo: false
#| results: 'asis'

if(includeScc){
result <- knitr::knit_child(text = knitr::knit_expand("self_controlled_cohort.qmd", quiet = TRUE, envir = environment()), quiet = TRUE)
cat(result, sep = '\n')
}
```
