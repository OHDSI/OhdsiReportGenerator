...
boxName <- paste0('Frequency of ',ibOutcome,' concept codes when the patient exposed to ', indexTar$friendlyNameTarget[1], ' ', indexTar$subsetTextTarget[1],' has the outcome during ', ibTar)
...
print(htmltools::tagList(
  indexTar  %>%  
    gt::gt() %>%
    gt::fmt_percent(
      columns = colnames(indexTar)[! colnames(indexTar) %in% c("covariateName","friendlyNameTarget","subsetTextTarget", "friendlyNameOutcome", "tar")],
      decimals = 2
    ) %>%
    gt::cols_label(
