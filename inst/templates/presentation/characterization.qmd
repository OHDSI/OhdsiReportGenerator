...
targetCharDf <- OhdsiReportGenerator::getCharacterizationTargets(
...
charTargetIds <- unique(targetCharDf$cohortDefinitionId)

targetsC <- targets %>% filter(
.data$cohortDefinitionId %in% !!charTargetIds
)
