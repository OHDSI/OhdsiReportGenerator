SELECT 
  ...
  SUM(cov.non_case_sum_value) AS non_case_count,	
  SUM(cov.case_sum_value) AS case_count,
  --SUM(cov.non_case_sum_value)*1.0/SUM(cov.non_case_sum_value*1.0/cov.non_case_average_value) AS non_case_average,	
  --SUM(cov.case_sum_value)*1.0/SUM(cov.case_sum_value*1.0/cov.case_average_value) AS case_average,	
