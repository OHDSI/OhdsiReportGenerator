select 
    ...
    i.outcomes_pe,
    i.outcomes,
    i.incidence_proportion_p_100p AS incidence_proportion_p100p,
    i.incidence_rate_p_100py AS incidence_rate_p100py
 ...
 ON ts.characterization_target_id = i.characterization_target_id
 AND ts.setting_id = i.setting_id
 AND ts.database_id = i.database_id
    ...
    {@use_characterization_target}?{ and i.characterization_target_id in (@characterization_target_id)}
