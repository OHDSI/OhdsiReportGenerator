CREATE INDEX IF NOT EXISTS ci_incidence_summary_idx ON @schema.@ci_table_prefixincidence_summary (database_id, characterization_target_id, tar_id, subgroup_id, outcome_id, age_group_id, gender_id);
CREATE INDEX IF NOT EXISTS ci_get_outcome_summary_tid_oid ON @schema.@ci_table_prefixincidence_summary(characterization_target_id,outcome_id);
...
CREATE INDEX IF NOT EXISTS ci_i_tar_ref_out ON @schema.@ci_table_prefixincidence_summary(characterization_target_id,ref_id, outcome_id);
