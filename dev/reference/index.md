...
- [`getIncidenceRates()`](getIncidenceRates.md) : Extract the cohort
  incidence result
- [`getIncidenceTargetSettings()`](getIncidenceTargetSettings.md) : A
  function to extarct the cohort incidence targets
- [`getNonCaseCounts()`](getNonCaseCounts.md) : Extract the non-cases
  counts result
...
- [`getOutcomesUsedInIncidence()`](getOutcomesUsedInIncidence.md) : A
  function to extract the outcomes found in incidence
- [`getTargetCounts()`](getTargetCounts.md) : Extract the target cohort
  counts result
...
- [`getTargetsUsedInIncidence()`](getTargetsUsedInIncidence.md) : A
  function to extract the targets found in incidence
...
- [`formatTargetPopulation()`](formatTargetPopulation.md) : output a
  string summarizing the target population
...
- [`getTarText()`](getTarText.md) : output a string summarizing the time
  at risk
